    ...
    def updateCalculatedData(self, __market, _calculatedData_ndArray, _index, _theTime):
        ...
        try:
            ...
            with connection.cursor() as cursor:
                ...
                cursor.execute(sql, (_theTime['intDate'], _index, str(_calculatedData_ndArray[0, _index]),
                                    str(_calculatedData_ndArray[1, _index]), str(_calculatedData_ndArray[2, _index]),
