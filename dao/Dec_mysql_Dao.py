    ...
    def getPrices_current(self, _curTimeInDate, _market):
        ...
        try:
            ...
            with connection.cursor() as cursor:
                ...
                elif Constantes.MARKET_STOXX50 == _market:
                    sql = query_sql.GET_CURRENT_PRICES_STOXX50
                #
        ...
        try:
            ...
            with connection.cursor() as cursor:
                ...
                if Constantes.MARKET_EUROFX == _market:
                    ...
                    sql = query_sql.GET_LAST_TICKS_BY_ID_LIST_STOXX50
                #
    ...
    * @return anything.
    ...
    def updateCalculatedData(self, __market, _calculatedData_ndArray, _index, _theTime):
        ...
        try:
            ...
            elif Constantes.MARKET_STOXX50 == __market:
                sql = query_sql.SQL_INSERT_UPDATE_CALCULATED_DATA_STOXX50
            #
        ...
        try:
            ...
            with connection.cursor() as cursor:
                ...
                if Constantes.MARKET_EUROFX == _market:
                    ...
                    sql = query_sql.GET_SESSION_LIST_STOXX50
                #
    ...
    def blankTables(self, _market):
        ...
        try:
            ...
            if Constantes.MARKET_EUROFX == _market:
                ...
                sql_delete = query_sql.DELETE_TICKS_DEC_STOXX50
            #
        ...
        try:
            ...
            if Constantes.MARKET_EUROFX == _market:
                ...
                sql_delete_02 = query_sql.DELETE_VISU_CALCULATED_DATA_STOXX50
            #
    ...
    def backupSession(self, _idSesion, _market):
        ...
        try:
            ...
            if Constantes.MARKET_EUROFX == _market:
                ...
                query_ct = query_sql.CREATE_TABLE_BACKUP_TICKS_DEC_DAX_01
                query_ct += str(_idSesion)
                query_ct += query_sql.CREATE_TABLE_BACKUP_TICKS_DEC_DAX_02
            elif Constantes.MARKET_BUND == _market:
                query_ct = query_sql.CREATE_TABLE_BACKUP_TICKS_DEC_BUND_01
                query_ct += str(_idSesion)
                query_ct += query_sql.CREATE_TABLE_BACKUP_TICKS_DEC_BUND_02
            elif Constantes.MARKET_STOXX50 == _market:
                query_ct = query_sql.CREATE_TABLE_BACKUP_TICKS_DEC_STOXX50_01
                query_ct += str(_idSesion)
                query_ct += query_sql.CREATE_TABLE_BACKUP_TICKS_DEC_STOXX50_02
            #
        ...
        try:
            ...
            if Constantes.MARKET_EUROFX == _market:
                ...
                query_ins_sel = query_sql.SELECT_INSERT_TICKS_BACKP_DEC_DAX_01
                query_ins_sel += str(_idSesion)
                query_ins_sel += query_sql.SELECT_INSERT_TICKS_BACKP_DEC_DAX_02
            elif Constantes.MARKET_BUND == _market:
                ...
                query_ins_sel = query_sql.SELECT_INSERT_TICKS_BACKP_DEC_STOXX50_01
                query_ins_sel += str(_idSesion)
                query_ins_sel += query_sql.SELECT_INSERT_TICKS_BACKP_DEC_STOXX50_02
            #        
        ...
        try :
            ...
            if Constantes.MARKET_EUROFX == _market:
                ...
                sql_delete = query_sql.DELETE_TICKS_BY_SESION_DEC_DAX
            elif Constantes.MARKET_BUND == _market:
                sql_delete = query_sql.DELETE_TICKS_BY_SESION_DEC_BUND
            elif Constantes.MARKET_STOXX50 == _market:
                sql_delete = query_sql.DELETE_TICKS_BY_SESION_DEC_STOXX50
            #
