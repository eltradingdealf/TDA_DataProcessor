...
TABLE_NAME_TICKS_BACKUP_DEC_DAX = 'trading_db.zbckp_ticks_dax'
TABLE_NAME_TICKS_BACKUP_DEC_BUND   = 'trading_db.zbckp_ticks_fnasdaq'
TABLE_NAME_TICKS_BACKUP_DEC_STOXX50   = 'trading_db.zbckp_ticks_stoxx50'
...
CREATE_TABLE_BACKUP_TICKS_DEC_STOXX50_01 =  'CREATE TABLE IF NOT EXISTS ' + TABLE_NAME_TICKS_BACKUP_DEC_STOXX50 + '_'
CREATE_TABLE_BACKUP_TICKS_DEC_STOXX50_02 = """                                          
                                          (
                                          ID BIGINT(20) UNSIGNED NOT NULL,
                                          tickdate INT(11) UNSIGNED NOT NULL,
                                          ticktime INT(11) UNSIGNED NOT NULL,
...
SELECT_INSERT_TICKS_BACKP_DEC_STOXX50_01 =   'INSERT INTO ' + TABLE_NAME_TICKS_BACKUP_DEC_STOXX50 + '_'
SELECT_INSERT_TICKS_BACKP_DEC_STOXX50_02 =   """ (ID, tickdate, ticktime, tickmili, ope, trade_price, trade_vol, buy_price, sell_price) 
                                                SELECT ID, 
                                                      tickdate, 
                                                      ticktime, 
                                                      tickmili,
                                                      ...
                                                      buy_price, 
                                                      sell_price 
                                                FROM trading_db.ticks_stoxx50
                                                ORDER BY ID ASC
                                          """


DELETE_TICKS_BY_SESION_DEC_STOXX50 =   'DELETE FROM trading_db.ticks_stoxx50 WHERE tickdate=%s '
DELETE_TICKS_DEC_STOXX50 =             'DELETE FROM trading_db.ticks_stoxx50 '


CREATE_TABLE_BACKUP_TICKS_DEC_DAX_01 =  'CREATE TABLE IF NOT EXISTS ' + TABLE_NAME_TICKS_BACKUP_DEC_DAX + '_'
CREATE_TABLE_BACKUP_TICKS_DEC_DAX_02 = """                                          
                                          (
                                          ID BIGINT(20) UNSIGNED NOT NULL,
                                          tickdate INT(11) UNSIGNED NOT NULL,
                                          ticktime INT(11) UNSIGNED NOT NULL,
...
SELECT_INSERT_TICKS_BACKP_DEC_DAX_01 =   'INSERT INTO ' + TABLE_NAME_TICKS_BACKUP_DEC_DAX + '_'
SELECT_INSERT_TICKS_BACKP_DEC_DAX_02 =   """ (ID, tickdate, ticktime, tickmili, ope, trade_price, trade_vol, buy_price, sell_price) 
                                                SELECT ID, 
                                                      tickdate, 
                                                      ticktime, 
                                                      tickmili,
...
DELETE_TICKS_BY_SESION_DEC_DAX =   'DELETE FROM trading_db.ticks_dax WHERE tickdate=%s '
...
DELETE_VISU_CALCULATED_DATA_STOXX50 =     'DELETE FROM trading_db.visu_datacalc_stoxx50'
...
GET_CURRENT_PRICES_STOXX50 =        """   SELECT tickdate,
                                                ticktime,
                                                tickmili, 
                                                buy_price,
                                                sell_price
                                          FROM trading_db.prices_stoxx50
                                          WHERE tickdate=%s
                                    """
...
GET_SESSION_LIST_STOXX50 =          """   SELECT DISTINCT(tickdate) as tickdate
                                          FROM trading_db.ticks_stoxx50
                                          ORDER BY tickdate ASC      
                                    """
...
GET_LAST_TICKS_BY_ID_LIST_STOXX50 = """   SELECT ID,
                                                tickdate,
                                                ticktime,
                                                tickmili, 
                                                ope,
...
SQL_INSERT_UPDATE_CALCULATED_DATA_STOXX50 =     """   INSERT INTO trading_db.visu_datacalc_stoxx50
                                                      (sessiondate, candle_id, delta, vol_avg, delta_strong, data03, data04, data05, data06
                                                      , data07, data08)
                                                      VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)  
                                                      ON DUPLICATE KEY UPDATE 
